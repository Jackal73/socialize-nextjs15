      ...
      <DialogContent className="bg-card p-0">
        ...
        <div>
          <div className="group relative">
            <SearchIcon className="absolute left-5 top-1/2 size-5 -translate-y-1/2 transform text-muted-foreground group-focus-within:text-amber-600" />
            <input
...
function UserResult({ user, selected, onClick }: UserResultProps) {
  return (
    ...
    >
      ...
      {selected && <Check className="size-5 text-amber-500" />}
    </button>
  );
}
